...
fn load_mecab_file(path: &str) -> std::io::Result<Document> {
...
fn print_noun_concatenation(doc: &Document) {
    for sentence in doc {
        sentence
...
fn word_frequency(doc: &Document) {
